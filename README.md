...
| 2 | ✅ **Completada** | **Text-to-Speech — La App Habla:** Web Speech API nativa, selección de voz en-US/en-GB, aproximación de pitch/rate para contornos de entonación (↘ ↗ ↘↗), sanitización de símbolos fonéticos |
| 3 | 🚧 **En curso** | **Speech Recognition — La App Escucha:** Captura de audio (micrófono) para que el estudiante lea las frases y el sistema valide si la pronunciación es correcta |
